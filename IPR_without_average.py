...
class Agent:
    ...
    def calculate_horizontal_relationship_1(self,a,c,d,f,g):
        ...
        option_based_on_dpr = self.closet_dpr_ratio_from_option(DPR_AC, g)
        option_based_on_dpr_2 = self.closet_dpr_ratio_from_option(DPR_DF, g)

        # option_based_on_ipr = self.closet_ipr_ratio_from_option(IPR_AC + IPR_DF / 2, g)
        return option_based_on_dpr, option_based_on_dpr_2
    ...
    def calculate_horizontal_relationship_2(self,b,c,e,f,h):
        ...
        option_based_on_dpr = self.closet_dpr_ratio_from_option(DPR_BC, h)
        option_based_on_dp_2 = self.closet_dpr_ratio_from_option(DPR_CF, h)

        # option_based_on_ipr = self.closet_ipr_ratio_from_option(IPR_BC + IPR_CF / 2, h)
        return option_based_on_dpr, option_based_on_dp_2
    ...
    def calculate_vertical_relationship_1(self,a,g,b,h,c):
        ...
        option_based_on_dpr = self.closet_dpr_ratio_from_option(DPR_AG, c)
        option_based_on_dp_2 = self.closet_dpr_ratio_from_option(DPR_BH, c)
    ...
    def calculate_vertical_relationship_2(self,d,g,e,h,f):
        ...
        option_based_on_dpr = self.closet_dpr_ratio_from_option(DPR_DG, f)
        option_based_on_dpr_2 = self.closet_dpr_ratio_from_option(DPR_EH, f)
